...
private:
  ...
  std::vector<rosbag::MessageInstance> pointcloud_msgs1_;     // "/wf/front_radar/parsed/float_data_1" 消息
  std::vector<rosbag::MessageInstance> pointcloud_msgs2_;     // "/wf/front_radar/parsed/float_data_2" 消息
  std::vector<rosbag::MessageInstance> pointcloud_msgs3_;     // "/wf/front_radar/parsed/float_data_3" 消息
  std::vector<rosbag::MessageInstance> pointcloud_msgs4_;     // "/wf/front_radar/parsed/float_data_4" 消息
  ...
  std::vector<rosbag::MessageInstance> cube_data_msgs0_;     // "/wf/front_radar/ti/cube_data_0" 消息
  std::vector<rosbag::MessageInstance> cube_data_msgs1_;
  std::vector<rosbag::MessageInstance> cube_data_msgs2_;
  std::vector<rosbag::MessageInstance> cube_data_msgs3_;
  std::vector<rosbag::MessageInstance> cube_data_msgs4_;
