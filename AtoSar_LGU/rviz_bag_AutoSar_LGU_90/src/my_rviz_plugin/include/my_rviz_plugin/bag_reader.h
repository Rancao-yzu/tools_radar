...
public:
  ...
  int findClosestObjectSpFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& object_sp_msgs);
...
private:
  ...
  std::vector<rosbag::MessageInstance> object_sp_msgs0_;
  std::vector<rosbag::MessageInstance> object_sp_msgs1_;
  std::vector<rosbag::MessageInstance> object_sp_msgs2_;
  std::vector<rosbag::MessageInstance> object_sp_msgs3_;
  std::vector<rosbag::MessageInstance> object_sp_msgs4_;
