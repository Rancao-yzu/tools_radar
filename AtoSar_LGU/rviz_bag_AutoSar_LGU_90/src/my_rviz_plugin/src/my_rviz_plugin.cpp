  ...
  frame_count3(0), frame_count4(0)
{
  ...
  sgu_pub0_ = nh_.advertise<arbe_msgs::wfSguRawData>("/wf/corner_radar/sgu_data_0", 10);  
  sgu_pub1_ = nh_.advertise<arbe_msgs::wfSguRawData>("/wf/corner_radar/sgu_data_1", 10);  
  sgu_pub2_ = nh_.advertise<arbe_msgs::wfSguRawData>("/wf/corner_radar/sgu_data_2", 10);  
  sgu_pub3_ = nh_.advertise<arbe_msgs::wfSguRawData>("/wf/corner_radar/sgu_data_3", 10);  
  sgu_pub4_ = nh_.advertise<arbe_msgs::wfSguRawData>("/wf/corner_radar/sgu_data_4", 10);  
                                          ...
                                          )
{
  ...
  boost::shared_ptr<arbe_msgs::wfSguRawData> object_sp_data0 = frame_msg[13].instantiate<arbe_msgs::wfSguRawData>();
  if (object_sp_data0&&(msg_flag[13]>=0))
  {
    sgu_pub0_.publish(*object_sp_data0);
  }

  boost::shared_ptr<arbe_msgs::wfSguRawData> object_sp_data1 = frame_msg[14].instantiate<arbe_msgs::wfSguRawData>();
  if (object_sp_data1&&(msg_flag[14]>=0))
  {
    sgu_pub1_.publish(*object_sp_data1);
  }

  boost::shared_ptr<arbe_msgs::wfSguRawData> object_sp_data2 = frame_msg[15].instantiate<arbe_msgs::wfSguRawData>();
  if (object_sp_data2&&(msg_flag[15]>=0))
  {
    sgu_pub2_.publish(*object_sp_data2);
  }

  boost::shared_ptr<arbe_msgs::wfSguRawData> object_sp_data3 = frame_msg[16].instantiate<arbe_msgs::wfSguRawData>();
  if (object_sp_data3&&(msg_flag[16]>=0))
  {
    sgu_pub3_.publish(*object_sp_data3);
  }

  boost::shared_ptr<arbe_msgs::wfSguRawData> object_sp_data4 = frame_msg[17].instantiate<arbe_msgs::wfSguRawData>();
  if (object_sp_data4&&(msg_flag[17]>=0))
  {
    sgu_pub4_.publish(*object_sp_data4);
  }
}
