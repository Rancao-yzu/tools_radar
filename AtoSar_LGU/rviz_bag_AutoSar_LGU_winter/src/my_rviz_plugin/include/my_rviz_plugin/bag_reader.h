...
private:
  ...
  std::vector<rosbag::MessageInstance> camera_msgs6_;
  std::vector<rosbag::MessageInstance> camera_msgs7_;
  std::vector<rosbag::MessageInstance> camera_msgs8_;
  std::vector<rosbag::MessageInstance> camera_msgs9_;
