...
public:
  ...
  void readBagFile(const std::string& file_path, int& frameCount0, int& frameSPCount0,int& frameRDCount0,int& frameCount1, int& frameSPCount1, int& frameRDCount1,int& frameCount2, 
  int& frameSPCount2,int& frameRDCount2,int& frameCount3, int& frameSPCount3,int& frameRDCount3,int& frameCount4, int& frameSPCount4, int& frameRDCount4);
  ...
  int findClosestFPtFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& pcl_sp_msgs);
  int findClosestRPtFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& pcl_rd_msgs);
...
private:
  ...
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs0_;
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs1_;
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs2_;
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs3_;
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs4_;
  std::vector<rosbag::MessageInstance> pointcloud_rd_msgs5_;
