...
private:
  ...
  ros::Publisher pointcloud_rd_pub0_;
  ros::Publisher pointcloud_rd_pub1_;
  ros::Publisher pointcloud_rd_pub2_;
  ros::Publisher pointcloud_rd_pub3_;
  ros::Publisher pointcloud_rd_pub4_;
  ros::Publisher pointcloud_rd_pub5_;
  ...
  int frame_count0, frame_sp_count0, frame_rd0;
  int frame_count1, frame_sp_count1, frame_rd1;
  int frame_count2, frame_sp_count2, frame_rd2;
  int frame_count3, frame_sp_count3, frame_rd3;
  int frame_count4, frame_sp_count4, frame_rd4;
