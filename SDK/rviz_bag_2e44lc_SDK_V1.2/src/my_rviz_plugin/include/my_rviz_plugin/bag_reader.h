...
public:
  ...
  int findClosestPtFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& pcl_msgs, std::vector<rosbag::MessageInstance>& pcl_sp_msgs);
  int findClosestFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& c_msgs);
  int findClosestObjFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& Obj_msgs);
...
private:
  ...
  std::vector<rosbag::MessageInstance> Object_tag_msgs_1;
  std::vector<rosbag::MessageInstance> Object_tag_msgs_2;
  std::vector<rosbag::MessageInstance> Object_tag_msgs_3;
  std::vector<rosbag::MessageInstance> Object_tag_msgs_4;

  std::vector<rosbag::MessageInstance> Object_msgs_1;
  std::vector<rosbag::MessageInstance> Object_msgs_2;
  std::vector<rosbag::MessageInstance> Object_msgs_3;
  std::vector<rosbag::MessageInstance> Object_msgs_4;
