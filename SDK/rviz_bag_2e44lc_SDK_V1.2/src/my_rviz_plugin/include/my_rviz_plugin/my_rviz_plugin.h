...
private:
  ...
  ros::Publisher Object_tag_msgs_pub1_;
  ros::Publisher Object_tag_msgs_pub2_;
  ros::Publisher Object_tag_msgs_pub3_;
  ros::Publisher Object_tag_msgs_pub4_;


  ros::Publisher Object_msgs_pub1_;
  ros::Publisher Object_msgs_pub2_;
  ros::Publisher Object_msgs_pub3_;
  ros::Publisher Object_msgs_pub4_;
