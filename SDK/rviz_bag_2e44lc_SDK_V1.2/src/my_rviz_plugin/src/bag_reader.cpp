  ...
  int& frameSPCount2,int& frameCount3, int& frameSPCount3,int& frameCount4, int& frameSPCount4)
{
  ...
  for (const auto& msg : view)
  {
    ...
    else if (msg.getTopic() == "/wf/rviz/objects_tags_1") 
	{
		Object_tag_msgs_1.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_tags_2") 
	{
		Object_tag_msgs_2.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_tags_3") 
	{
		Object_tag_msgs_3.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_tags_4") 
	{
		Object_tag_msgs_4.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_1")  
	{
		Object_msgs_1.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_2")  
	{
		Object_msgs_2.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_3")  
	{
		Object_msgs_3.push_back(msg);
	}
    else if (msg.getTopic() == "/wf/rviz/objects_4")  
	{
		Object_msgs_4.push_back(msg);
	}
    count++;
    if(update_progress_bar_callback_)
    {
