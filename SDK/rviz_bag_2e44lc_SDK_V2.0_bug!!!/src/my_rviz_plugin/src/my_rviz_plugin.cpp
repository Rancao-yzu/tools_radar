  ...
  frame_count3(0), frame_sp_count3(0), frame_count4(0), frame_sp_count4(0)
{
  ...
  imu_pub_ = nh_.advertise<arbe_msgs::ImuOutput>("/wf/imu_data/parsed", 10);

  Object_tag_msgs_pub1_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_tags_1", 10);
  Object_tag_msgs_pub2_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_tags_2", 10);
  Object_tag_msgs_pub3_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_tags_3", 10);
  Object_tag_msgs_pub4_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_tags_4", 10);

  Object_msgs_pub1_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_1", 10);
  Object_msgs_pub2_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_2", 10);
  Object_msgs_pub3_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_3", 10);
  Object_msgs_pub4_ = nh_.advertise<visualization_msgs::MarkerArray>("/wf/rviz/objects_4", 10);
  ...
  play_object_date_= new QCheckBox("Object");
  ...
  control_layout->addWidget(play_object_date_);
  ...
  connect(play_object_date_, SIGNAL(stateChanged(int)), this, SLOT(setObjectFlag(int)));
                                          ...
                                          )
{
  ...
  if(!bSPFlag)
  {
    ...
    boost::shared_ptr<arbe_msgs::wfRawDataMsg> pointcloud_data1 = frame_msg[1].instantiate<arbe_msgs::wfRawDataMsg>();
    if (pointcloud_data1&&(msg_flag[1]>=0))
      pointcloud_pub1_.publish(*pointcloud_data1);
    else
      ROS_INFO("pointcloud_data1 is null");

    boost::shared_ptr<arbe_msgs::wfRawDataMsg> pointcloud_data2 = frame_msg[2].instantiate<arbe_msgs::wfRawDataMsg>();
    if (pointcloud_data2&&(msg_flag[2]>=0))
    {
      uint16_t custom_frame_id = pointcloud_data2->frame_id;
      ros::Time time_ = pointcloud_data2->header.stamp;
    ...
    boost::shared_ptr<arbe_msgs::wfRawDataMsg> pointcloud_data3 = frame_msg[3].instantiate<arbe_msgs::wfRawDataMsg>();
    if (pointcloud_data3&&(msg_flag[3]>=0))
    {
      uint16_t custom_frame_id = pointcloud_data3->frame_id;
    ...
    boost::shared_ptr<arbe_msgs::wfRawDataMsg> pointcloud_data4 = frame_msg[4].instantiate<arbe_msgs::wfRawDataMsg>();
  ...
  if(Object_Flag)
  {
    ROS_INFO("!----------------Object_msgs_data is going--------------!");

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_tag_msgs_data1= frame_msg[14].instantiate<visualization_msgs::MarkerArray>();
    if (Object_tag_msgs_data1&&(msg_flag[14]>=0))
      Object_tag_msgs_pub1_.publish(*Object_tag_msgs_data1);
    else
      ROS_INFO("Object_tag_msgs_data1 is null");

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_tag_msgs_data2= frame_msg[15].instantiate<visualization_msgs::MarkerArray>();
    if (Object_tag_msgs_data2&&(msg_flag[15]>=0))
      Object_tag_msgs_pub2_.publish(*Object_tag_msgs_data2);
    else
      ROS_INFO("Object_tag_msgs_data2 is null");

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_tag_msgs_data3= frame_msg[16].instantiate<visualization_msgs::MarkerArray>();
    if (Object_tag_msgs_data3&&(msg_flag[16]>=0))
      Object_tag_msgs_pub3_.publish(*Object_tag_msgs_data3);

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_tag_msgs_data4= frame_msg[17].instantiate<visualization_msgs::MarkerArray>();
    if (Object_tag_msgs_data4&&(msg_flag[17]>=0))
      Object_tag_msgs_pub4_.publish(*Object_tag_msgs_data4);

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_msgs_data1= frame_msg[18].instantiate<visualization_msgs::MarkerArray>();
    if (Object_msgs_data1&&(msg_flag[18]>=0))
      Object_msgs_pub1_.publish(*Object_msgs_data1);
    else
      ROS_INFO("Object_msgs_data1 is null");

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_msgs_data2= frame_msg[19].instantiate<visualization_msgs::MarkerArray>();
    if (Object_msgs_data2&&(msg_flag[19]>=0))
      Object_msgs_pub2_.publish(*Object_msgs_data2);
    else
      ROS_INFO("Object_msgs_data2 is null");

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_msgs_data3= frame_msg[20].instantiate<visualization_msgs::MarkerArray>();
    if (Object_msgs_data3&&(msg_flag[20]>=0))
      Object_msgs_pub3_.publish(*Object_msgs_data3);

    boost::shared_ptr<visualization_msgs::MarkerArray> Object_msgs_data4= frame_msg[21].instantiate<visualization_msgs::MarkerArray>();
    if (Object_msgs_data4&&(msg_flag[21]>=0))
      Object_msgs_pub4_.publish(*Object_msgs_data4);
...
void MyRvizPlugin::readBagFile()// 2025/9/17
{
  ...
  if (!path.empty() && static_cast<void*>(const_cast<char*>(last_path.c_str())) != static_cast<void*>(const_cast<char*>(path.c_str())))
  {
    ...
    if(mainRadarIndex_ == 0)
    {
      ...
      {
        frame_spinner_->setMaximum(frame_sp_count0);
        frame_slider_->setMaximum(frame_sp_count0);
      }
    }
    else if(mainRadarIndex_ == 1)
    {
      ...
      {
        frame_spinner_->setMaximum(frame_sp_count1);
        frame_slider_->setMaximum(frame_sp_count1);
      }
    }
    else if(mainRadarIndex_ == 2)
    {
      ...
      {
        frame_spinner_->setMaximum(frame_sp_count2);
        frame_slider_->setMaximum(frame_sp_count2);
      }
    }
    else if(mainRadarIndex_ == 3)
    {
      ...
      {
        frame_spinner_->setMaximum(frame_sp_count3);
        frame_slider_->setMaximum(frame_sp_count3);
      }
    }
    else if(mainRadarIndex_ == 4)
    {
      ...
      {
        frame_spinner_->setMaximum(frame_sp_count4);
        frame_slider_->setMaximum(frame_sp_count4);
      }
    }
    ...
    play_object_date_->setEnabled(true);
    ...
    ROS_ERROR("Failed to read bag file: %s", e.what());
  }
  catch (const std::exception& e) {
    ROS_ERROR("Unexpected error while reading bag file: %s", e.what());
  }
}

void MyRvizPlugin::setObjectFlag(int flag)
{
  Object_Flag = (flag != 0); 
}
