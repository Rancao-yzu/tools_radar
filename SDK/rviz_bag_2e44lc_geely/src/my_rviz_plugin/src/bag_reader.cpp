  ...
  int& frameSPCount2,int& frameCount3, int& frameSPCount3,int& frameCount4, int& frameSPCount4)
{
  ...
  // 只读取指定的话题
  std::vector<std::string> topics = {"/wf/corner_radar/postprocess_data_0","/wf/corner_radar/postprocess_data_1", "/wf/corner_radar/postprocess_data_2", 
    "/wf/corner_radar/postprocess_data_3", "/wf/corner_radar/postprocess_data_4", 
  ...
  for (const auto& msg : view)
  {
    ...
    else if (msg.getTopic() == "/wf/corner_radar/postprocess_data_0")
    {
      pointcloud_msgs0_.push_back(msg);
    }
    else if (msg.getTopic() == "/wf/corner_radar/postprocess_data_1")
    {
      pointcloud_msgs1_.push_back(msg);
    }
    else if (msg.getTopic() == "/wf/corner_radar/postprocess_data_2")
    {
      pointcloud_msgs2_.push_back(msg);
    }
    else if (msg.getTopic() == "/wf/corner_radar/postprocess_data_3")
    {
      pointcloud_msgs3_.push_back(msg);
    }
    else if (msg.getTopic() == "/wf/corner_radar/postprocess_data_4")
    {
