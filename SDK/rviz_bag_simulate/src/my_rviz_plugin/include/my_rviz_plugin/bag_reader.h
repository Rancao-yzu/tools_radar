...
public:
  ...
  using PlayFinishedCallback = std::function<void()>;
  ...
  void setPlayFinishedCallback(PlayFinishedCallback callback);
  ...
  int findClosestSimulateFrame(const ros::Time& selected_time, std::vector<rosbag::MessageInstance>& simulate_msgs);
...
private:
  ...
  std::vector<rosbag::MessageInstance> simulate_msgs0_;
  std::vector<rosbag::MessageInstance> simulate_msgs1_;
  std::vector<rosbag::MessageInstance> simulate_msgs2_;
  std::vector<rosbag::MessageInstance> simulate_msgs3_;
  std::vector<rosbag::MessageInstance> simulate_msgs4_;
  ...
  PlayFinishedCallback play_finished_callback_;
  std::mutex frame_mutex;
  const int MAX_TOPIC_NUM = 18;
};
