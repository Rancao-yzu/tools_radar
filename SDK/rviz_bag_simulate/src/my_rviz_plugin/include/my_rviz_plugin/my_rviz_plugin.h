...
#include <arbe_msgs/wfSimulateData.h>
...
private:
  ...
  ros::Publisher simulate_pub0_;
  ros::Publisher simulate_pub1_;
  ros::Publisher simulate_pub2_;
  ros::Publisher simulate_pub3_;
  ros::Publisher simulate_pub4_;
