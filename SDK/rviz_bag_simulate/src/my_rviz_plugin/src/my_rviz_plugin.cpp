  ...
  mainRadarIndex_(0)
{
  ...
  simulate_pub0_ = nh_.advertise<arbe_msgs::wfSimulateData>("/wf/corner_radar/simulate_data_0", 10);
  simulate_pub1_ = nh_.advertise<arbe_msgs::wfSimulateData>("/wf/corner_radar/simulate_data_1", 10);
  simulate_pub2_ = nh_.advertise<arbe_msgs::wfSimulateData>("/wf/corner_radar/simulate_data_2", 10);
  simulate_pub3_ = nh_.advertise<arbe_msgs::wfSimulateData>("/wf/corner_radar/simulate_data_3", 10);
  simulate_pub4_ = nh_.advertise<arbe_msgs::wfSimulateData>("/wf/corner_radar/simulate_data_4", 10);
  ...
  select_main_radar_->addItem("前右(2)");
  select_main_radar_->addItem("后左(3)");
  select_main_radar_->addItem("后右(4)");
  select_main_radar_->addItem("后(5)");
  ...
  bag_reader_->setPlayFinishedCallback([this](){
    QMetaObject::invokeMethod(this, "stopBag", Qt::QueuedConnection);
  });
                                          ...
                                          )
{
  ...
  if(!bSPFlag)
  {
    boost::shared_ptr<arbe_msgs::wfSimulateData> simulate_data0 = frame_msg[13].instantiate<arbe_msgs::wfSimulateData>();
    if (simulate_data0&&(msg_flag[13]>=0))
    {
      simulate_pub0_.publish(*simulate_data0);
    }

    boost::shared_ptr<arbe_msgs::wfSimulateData> simulate_data1 = frame_msg[14].instantiate<arbe_msgs::wfSimulateData>();
    if (simulate_data1&&(msg_flag[14]>=0))
    {
      simulate_frame_id = simulate_data1->frameID;
      ROS_INFO("simulate_data1 frame_id:: %d", simulate_frame_id);
      simulate_pub1_.publish(*simulate_data1);
    }


    boost::shared_ptr<arbe_msgs::wfSimulateData> simulate_data2 = frame_msg[15].instantiate<arbe_msgs::wfSimulateData>();
    if (simulate_data2&&(msg_flag[15]>=0))
    {
      simulate_pub2_.publish(*simulate_data2);
    }


    boost::shared_ptr<arbe_msgs::wfSimulateData> simulate_data3 = frame_msg[16].instantiate<arbe_msgs::wfSimulateData>();
    if (simulate_data3&&(msg_flag[16]>=0))
    {
      simulate_pub3_.publish(*simulate_data3);
    }

    boost::shared_ptr<arbe_msgs::wfSimulateData> simulate_data4 = frame_msg[17].instantiate<arbe_msgs::wfSimulateData>();
    if (simulate_data4&&(msg_flag[17]>=0))
    {
      simulate_pub4_.publish(*simulate_data4);
    }
 
    
    ros::Duration(0.001 * 1).sleep(); 
    ...
    {     
       uint16_t custom_frame_id1 = pointcloud_data1->frame_id;
      ROS_INFO("Pointcloud1 custom frame_id: %d", custom_frame_id1);
        if(simulate_frame_id != custom_frame_id1)
        {
            ROS_ERROR("Frame ID mismatch: simulate_frame_id=%d, custom_frame_id1=%d", 
                      simulate_frame_id, custom_frame_id1);
        }
