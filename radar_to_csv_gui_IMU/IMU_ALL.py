...
class ImuToCSVApp:
    def __init__(self, root):
        ...
        # 定义IMU消息的字段映射
        self.field_mapping = {
            'dut_timestamp': 'timestamp',
            'Target1Distance': 'Target1Distance',
            'Target1HeadingDiff': 'Target1HeadingDiff', 
            'Target1RelativeSpeed': 'Target1RelativeSpeed',
            'Target1LocationMode': 'Target1LocationMode',
            'Target1SatelliteCount': 'Target1SatelliteCount',
            'Target1PitchAngle': 'Target1PitchAngle',
            'Target1RollAngle': 'Target1RollAngle',
            'Target1SlipAngle': 'Target1SlipAngle',
            'Target1Longitude': 'Target1Longitude',
            'Target1Latitude': 'Target1Latitude',
            'Target1LngDistance': 'Target1LngDistance',
            'Target1LatDistance': 'Target1LatDistance',
            'Target1AcceY': 'Target1AcceY',
            'Target1closestDistance2S': 'Target1closestDistance2S',
            'Target1Heading': 'Target1Heading',
            'Target1AcceX': 'Target1AcceX',
            'Target1Altitude': 'Target1Altitude',
            'Target1TimeHeadway': 'Target1TimeHeadway',
            'Target1LngSpeedms': 'Target1LngSpeedms',
            'Target1LngTTC': 'Target1LngTTC',
            'Target1LatTTC': 'Target1LatTTC',
            'Target1YawRate': 'Target1YawRate',
            'positionX': 'Target1CoorX',
            'positionY': 'Target1CoorY',
            'Target1Angle': 'Target1Angle',
            'Target1Id': 'Target1Id',
            'Target1SpeedKPH': 'Target1SpeedKPH',
            'Target1LngSpeedKPH': 'Target1LngSpeedKPH',
            'Target1LatSpeedms': 'Target1LatSpeedms',
            'Target1RelLatAcc': 'Target1RelLatAcc',
            'Target1RelLngAcc': 'Target1RelLngAcc',
            'Target1RelLngSpeed': 'Target1RelLngSpeed',
            'Ego1SpeedKPH': 'Ego1SpeedKPH',
            'Ego1LngSpeedKPH': 'Ego1LngSpeedKPH',
            'Ego1LatSpeedms': 'Ego1LatSpeedms',
            'Ego1YawRate': 'Ego1YawRate',
            'Ego1LocationMode': 'Ego1LocationMode',
            'Ego1SatelliteCount': 'Ego1SatelliteCount',
            'Ego1LngAcce': 'Ego1LngAcce',
            'Ego1LatAcce': 'Ego1LatAcce',
            'Ego1Heading': 'Ego1Heading'
        }
